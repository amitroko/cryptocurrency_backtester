...
class Evaluator:
    def __init__(self, strategy, settings:dict = {'indicators': ['low_boll', 'fast_sma', 'slow_sma']}):
    ...
    # backtest all strategies on symbols received from binance
    def backtest(self,
                 model,
    ...
    # print summary of complete backtest results
